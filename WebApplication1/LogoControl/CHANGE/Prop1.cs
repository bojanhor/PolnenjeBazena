...
namespace WebApplication1
{
    public class Prop1 : PropComm
    {
        ...
        public Prop1(Sharp7.S7Client client):base(client)
        {
            ...
            XImpulses2 = new PlcVars.Word(this, new PlcVars.WordAddress(218), true) { SyncEvery_X_Time = 3 };
            YImpulses2 = new PlcVars.Word(this, new PlcVars.WordAddress(220), true) { SyncEvery_X_Time = 3 };
            ...
            JoyStickCommandX1 = new PlcVars.AlarmBit(this, new PlcVars.BitAddress(90, 0),"Ročni pomik X1" , false, false, true) { SyncEvery_X_Time = 2 };
            JoyStickCommandX2 = new PlcVars.AlarmBit(this, new PlcVars.BitAddress(91, 0), "Ročni pomik X2", false, false, true) { SyncEvery_X_Time = 2 };
            JoyStickCommandY1 = new PlcVars.AlarmBit(this, new PlcVars.BitAddress(92, 0), "Ročni pomik Y1", false, false, true) { SyncEvery_X_Time = 2 };
            JoyStickCommandY2 = new PlcVars.AlarmBit(this, new PlcVars.BitAddress(93, 0), "Ročni pomik Y2", false, false, true) { SyncEvery_X_Time = 2 };
            ...
            ZigZagzRobom = new PlcVars.Bit(this, new PlcVars.BitAddress(7, 0), true) { SyncEvery_X_Time = 3 };
            ZigZagzRobom_read = new PlcVars.AlarmBit(this, new PlcVars.BitAddress(168, 0), "AKTIVEN PROCES: ZigZag") { SyncEvery_X_Time = 3 };
